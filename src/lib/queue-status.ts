...
export const QUEUE_STATUS_CONFIG: Record<QueueStatus, { 
  ...
  WAITING: { label: "Menunggu Anamnesa", color: "text-blue-700", bgColor: "bg-blue-100", variant: "default" },
  ANAMNESA: { label: "Sedang Anamnesa", color: "text-orange-700", bgColor: "bg-orange-100", variant: "secondary" },
  WAITING_DOCTOR: { label: "Menunggu Dokter", color: "text-purple-700", bgColor: "bg-purple-100", variant: "secondary" },
  WITH_DOCTOR: { label: "Dengan Dokter", color: "text-green-700", bgColor: "bg-green-100", variant: "secondary" },
